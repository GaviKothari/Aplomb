...
export function createApiClient(getToken: () => Promise<string | null>) {
  ...
  return {
    ...
    employees: {
      ...
      suspend:       (id: string) => api<any>(`/employees/${id}/suspend`,        { method: 'POST' }),
      ...
      resendInvite:  (id: string) => api<any>(`/employees/${id}/resend-invite`,  { method: 'POST' }),
      resendWelcome: (id: string) => api<any>(`/employees/${id}/resend-invite`,  { method: 'POST' }),
