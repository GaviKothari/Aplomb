...
import { TrendingUp, Filter, RotateCcw, Download, MapPin, Home, Building2, Landmark } from 'lucide-react'
  ...
  return (
    <AppLayout>
      <div className="space-y-6">
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Property Transactions</h1>
          <p className="text-muted-foreground mt-2">Track property transaction analytics, market trends, and valuation patterns across all locations</p>
        </div>
